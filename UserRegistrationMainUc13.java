...
public class UserRegistrationMainUc13 {
	...
	public static void main(String[] args) {
           ...
           System.out.println(firstName .test("Sangeetha"));
           
           System.out.println("Lastname :");
           Predicate<String> lastName = i ->i.matches("^[A-Za-z]{3,26}$");
           System.out.println( lastName.test("posam"));
           ...
           System.out.println( mobilenumber.test("91 9701987058"));
           
           System.out.println("Password :");
           Predicate<String> password = i ->i.matches("^([aA-zZ]{8,})[0-9]{3}[@$+&*]{1}$");
           System.out.println( password.test("Sangeetha157@"));
	}
